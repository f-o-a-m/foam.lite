...
(function($PS) {
  ...
  var eqTransactionStatus = new Data_Eq.Eq(function (x) {
      return function (y) {
  ...
  exports["eqTransactionStatus"] = eqTransactionStatus;
...
(function($PS) {
  ...
  var showDAppMessage = new Data_Show.Show(function (v) {
      if (v instanceof Location) {
          return "L:" + (Data_Show.show(Data_Show.showNumber)(v.value0.lat) + ("," + Data_Show.show(Data_Show.showNumber)(v.value0.lon)));
      };
      if (v instanceof ArbitraryString) {
          return "A:" + v.value0;
      };
      if (v instanceof LocationWithArbitrary) {
          return "M:" + (Data_Show.show(Data_Show.showNumber)(v.value0.lat) + ("," + (Data_Show.show(Data_Show.showNumber)(v.value0.lon) + ("," + v.value0.string))));
      };
      throw new Error("Failed pattern match at DApp.Message (line 35, column 1 - line 38, column 108): " + [ v.constructor.name ]);
  });
  ...
  var genericDAppMessage = new Data_Generic_Rep.Generic(function (x) {
      if (x instanceof Location) {
          return new Data_Generic_Rep.Inl(x.value0);
      };
      if (x instanceof ArbitraryString) {
          return new Data_Generic_Rep.Inr(new Data_Generic_Rep.Inl(x.value0));
      };
      if (x instanceof LocationWithArbitrary) {
          return new Data_Generic_Rep.Inr(new Data_Generic_Rep.Inr(x.value0));
      };
      throw new Error("Failed pattern match at DApp.Message (line 34, column 1 - line 34, column 60): " + [ x.constructor.name ]);
  }, function (x) {
      if (x instanceof Data_Generic_Rep.Inl) {
          return new Location(x.value0);
      };
      if (x instanceof Data_Generic_Rep.Inr && x.value0 instanceof Data_Generic_Rep.Inl) {
          return new ArbitraryString(x.value0.value0);
      };
      if (x instanceof Data_Generic_Rep.Inr && x.value0 instanceof Data_Generic_Rep.Inr) {
          return new LocationWithArbitrary(x.value0.value0);
      };
      throw new Error("Failed pattern match at DApp.Message (line 34, column 1 - line 34, column 60): " + [ x.constructor.name ]);
  });
  ...
  exports["genericDAppMessage"] = genericDAppMessage;
  exports["showDAppMessage"] = showDAppMessage;
})(PS);
(function($PS) {
  // Generated by purs version 0.13.8
  "use strict";
...
(function($PS) {
  ...
  var genericSignedInterpretedMessage = new Data_Generic_Rep.Generic(function (x) {
      return x;
  }, function (x) {
      return x;
  });
  var genericMessageInterpretation = new Data_Generic_Rep.Generic(function (x) {
      if (x instanceof Interpreted) {
          return new Data_Generic_Rep.Inl(new Data_Generic_Rep.Product(x.value0, x.value1));
      };
      if (x instanceof Uninterpreted) {
          return new Data_Generic_Rep.Inr(x.value0);
      };
      throw new Error("Failed pattern match at DApp.Relay.Types (line 277, column 1 - line 277, column 84): " + [ x.constructor.name ]);
  }, function (x) {
      if (x instanceof Data_Generic_Rep.Inl) {
          return new Interpreted(x.value0.value0, x.value0.value1);
      };
      if (x instanceof Data_Generic_Rep.Inr) {
          return new Uninterpreted(x.value0);
      };
      throw new Error("Failed pattern match at DApp.Relay.Types (line 277, column 1 - line 277, column 84): " + [ x.constructor.name ]);
  });
  var showMessageInterpretation = function (dictShow) {
      return new Data_Show.Show(Data_Generic_Rep_Show.genericShow(genericMessageInterpretation)(Data_Generic_Rep_Show.genericShowSum(Data_Generic_Rep_Show.genericShowConstructor(Data_Generic_Rep_Show.genericShowArgsProduct(Data_Generic_Rep_Show.genericShowArgsArgument(dictShow))(Data_Generic_Rep_Show.genericShowArgsArgument(Data_ByteString.showByteString)))(new Data_Symbol.IsSymbol(function () {
          return "Interpreted";
      })))(Data_Generic_Rep_Show.genericShowConstructor(Data_Generic_Rep_Show.genericShowArgsArgument(Data_ByteString.showByteString))(new Data_Symbol.IsSymbol(function () {
          return "Uninterpreted";
      })))));
  };
  var showSignedInterpretedMessage = function (dictShow) {
      return new Data_Show.Show(Data_Generic_Rep_Show.genericShow(genericSignedInterpretedMessage)(Data_Generic_Rep_Show.genericShowConstructor(Data_Generic_Rep_Show.genericShowArgsArgument(Data_Show.showRecord()(Data_Show.showRecordFieldsCons(new Data_Symbol.IsSymbol(function () {
          return "feeAmount";
      }))(Data_Show.showRecordFieldsCons(new Data_Symbol.IsSymbol(function () {
          return "nonce";
      }))(Data_Show.showRecordFieldsCons(new Data_Symbol.IsSymbol(function () {
          ...
          return "tokenData";
      }))(Data_Show.showRecordFieldsNil)(showMessageInterpretation(dictShow)))(Network_Ethereum_Core_Signatures.showSignature))(Network_Ethereum_Web3_Solidity_UInt.showUIntN))(Network_Ethereum_Web3_Solidity_UInt.showUIntN))))(new Data_Symbol.IsSymbol(function () {
          return "SignedInterpretedMessage";
      }))));
  };
  var genericInterpretedDecodedMessage = function (dictGeneric) {
      return new Data_Generic_Rep.Generic(function (x) {
          if (x instanceof DecodedInterpretedMint) {
              return new Data_Generic_Rep.Inl(x.value0);
          };
          if (x instanceof DecodedInterpretedTransfer) {
              return new Data_Generic_Rep.Inr(new Data_Generic_Rep.Inl(x.value0));
          };
          if (x instanceof DecodedInterpretedBoth) {
              return new Data_Generic_Rep.Inr(new Data_Generic_Rep.Inr(x.value0));
          };
          throw new Error("Failed pattern match at DApp.Relay.Types (line 297, column 1 - line 297, column 111): " + [ x.constructor.name ]);
      }, function (x) {
          if (x instanceof Data_Generic_Rep.Inl) {
              return new DecodedInterpretedMint(x.value0);
          };
          if (x instanceof Data_Generic_Rep.Inr && x.value0 instanceof Data_Generic_Rep.Inl) {
              return new DecodedInterpretedTransfer(x.value0.value0);
          };
          if (x instanceof Data_Generic_Rep.Inr && x.value0 instanceof Data_Generic_Rep.Inr) {
              return new DecodedInterpretedBoth(x.value0.value0);
          };
          throw new Error("Failed pattern match at DApp.Relay.Types (line 297, column 1 - line 297, column 111): " + [ x.constructor.name ]);
      });
  };
  var showInterpretedDecodedMessage = function (dictGeneric) {
      return function (dictShow) {
          return new Data_Show.Show(Data_Generic_Rep_Show.genericShow(genericInterpretedDecodedMessage(dictGeneric))(Data_Generic_Rep_Show.genericShowSum(Data_Generic_Rep_Show.genericShowConstructor(Data_Generic_Rep_Show.genericShowArgsArgument(showSignedInterpretedMessage(dictShow)))(new Data_Symbol.IsSymbol(function () {
              return "DecodedInterpretedMint";
              ...
              return "transfer";
          }))(Data_Show.showRecordFieldsNil)(showSignedRelayedTransfer))(showSignedInterpretedMessage(dictShow)))))(new Data_Symbol.IsSymbol(function () {
              return "DecodedInterpretedBoth";
          }))))));
      };
  }; 
  ...
  exports["showInterpretedDecodedMessage"] = showInterpretedDecodedMessage;
...
(function($PS) {
  ...
  exports["MimeParse"] = MimeParse;
  exports["AllMimeRender"] = AllMimeRender;
  exports["allMimeRenderAlt"] = allMimeRenderAlt;
})(PS);
(function($PS) {
  // Generated by purs version 0.13.8
  "use strict";
...
(function($PS) {
  ...
  var selectContent = function (v) {
      if (v instanceof Anything) {
          ...
          return function ($22) {
              return $21(Data_List_NonEmpty.head($22));
          };
      };
  ...
  var getAcceptable = function (dictMonad) {
      var $28 = Nodetrout_Internal_Request.headerValue("accept");
      return function ($29) {
          return (function (v) {
              if (v instanceof Data_Maybe.Nothing) {
              ...
              if (v instanceof Data_Maybe.Just) {
                  ...
                  var acceptable = (function () {
                      var $16 = !Data_Foldable.elem(Data_Foldable.foldableArray)(Data_Eq.eqString)("*/*")(values);
                      if ($16) {
                          return Required.create;
                      };
                      return Preferred.create;
                  })();
                  var $17 = Data_Array.length(mimeTypes) === 0;
                  if ($17) {
      ...
      return function (request) {
          return function (available) {
              return Control_Bind.bind(Control_Monad_Except_Trans.bindExceptT(dictMonad))(getAcceptable(dictMonad)(request))(function (acceptable) {
                  ...
                  if (v instanceof Data_Maybe.Just) {
                      return Control_Applicative.pure(Control_Monad_Except_Trans.applicativeExceptT(dictMonad))(v.value0);
                  };
                  throw new Error("Failed pattern match at Nodetrout.Internal.Content (line 33, column 3 - line 37, column 19): " + [ v.constructor.name ]);
              });
          };
      };
  };
                              ...
                              return function (depth) {
                                  return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_Except_Trans.bindExceptT(dictMonad))(Control_Applicative.when(Control_Monad_Except_Trans.applicativeExceptT(dictMonad))(!Data_Array["null"](Nodetrout_Internal_Request.path(request)))(Control_Monad_Error_Class.throwError(Control_Monad_Except_Trans.monadThrowExceptT(dictMonad))({
                                      ...
                                      return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_Except_Trans.bindExceptT(dictMonad))(Control_Applicative.when(Control_Monad_Except_Trans.applicativeExceptT(dictMonad))(Data_Eq.notEq(Data_Either.eqEither(Data_HTTP_Method.eqMethod)(Data_HTTP_Method.eqCustomMethod))(Nodetrout_Internal_Request.method(request))(Data_HTTP_Method.fromString(Data_Symbol.reflectSymbol(dictIsSymbol)(Data_Symbol.SProxy.value))))(Control_Monad_Error_Class.throwError(Control_Monad_Except_Trans.monadThrowExceptT(dictMonad))({
                                          ...
                                          return Control_Bind.bind(Control_Monad_Except_Trans.bindExceptT(dictMonad))(Record.get(dictIsSymbol)()(Data_Symbol.SProxy.value)(handlers))(function (body) {
                                              return Control_Bind.bind(Control_Monad_Except_Trans.bindExceptT(dictMonad))(Nodetrout_Internal_Content.negotiate(dictMonad)(request)(Type_Trout_ContentType.allMimeRender(dictAllMimeRender)(Type_Proxy["Proxy"].value)(body)))(function (content) {
                                          ...
                                          return Control_Bind.bind(Control_Monad_Except_Trans.bindExceptT(dictMonad))(Control_Monad_Trans_Class.lift(Control_Monad_Except_Trans.monadTransExceptT)(dictMonad)(Control_Monad_Except_Trans.runExceptT(route(dictRouter)(Type_Proxy["Proxy"].value)(Record.get(dictIsSymbol)()(Data_Symbol.SProxy.value)(handlers))(request)(depth))))(function (eitherResult1) {
                                              ...
                                              if (eitherResult1 instanceof Data_Either.Left) {
                                                  return Control_Bind.bind(Control_Monad_Except_Trans.bindExceptT(dictMonad))(Control_Monad_Trans_Class.lift(Control_Monad_Except_Trans.monadTransExceptT)(dictMonad)(Control_Monad_Except_Trans.runExceptT(route(dictRouter1)(Type_Proxy["Proxy"].value)(Record["delete"](dictIsSymbol)()()(Data_Symbol.SProxy.value)(handlers))(request)(depth))))(function (eitherResult2) {
                                                      ...
                                                      throw new Error("Failed pattern match at Nodetrout.Internal.Router (line 74, column 9 - line 78, column 52): " + [ eitherResult2.constructor.name ]);
                                                  });
                                              };
                                              throw new Error("Failed pattern match at Nodetrout.Internal.Router (line 69, column 5 - line 78, column 52): " + [ eitherResult1.constructor.name ]);
                                          });
                                      };
                                  };
                              };
                      ...
                      return function (request) {
                          return function (depth) {
                              ...
                              if (v1.value0 instanceof Data_Maybe.Just) {
                                  ...
                                  throw new Error("Failed pattern match at Nodetrout.Internal.Router (line 110, column 9 - line 114, column 53): " + [ v2.constructor.name ]);
                              };
                              return Control_Monad_Error_Class.throwError(Control_Monad_Except_Trans.monadThrowExceptT(dictMonad))({
                                  priority: depth,
                                  details: Nodetrout_Internal_Error.error404.details,
              ...
              return function (dictMimeParse) {
                  return new Router(function (v) {
                      return function (handlers) {
                          return function (request) {
                              return function (depth) {
                                  return Control_Bind.bind(Control_Monad_Except_Trans.bindExceptT(dictMonad))(Effect_Aff_Class.liftAff(Effect_Aff_Class.monadAffExceptT(dictMonadAff))(Nodetrout_Internal_Request.stringBody(request)))(function (v1) {
                                      if (v1 instanceof Data_Maybe.Just) {
                                          var v2 = Type_Trout_ContentType.mimeParse(dictMimeParse)(Type_Proxy["Proxy"].value)(v1.value0);
                                          if (v2 instanceof Data_Either.Right) {
                                          ...
                                          throw new Error("Failed pattern match at Nodetrout.Internal.Router (line 194, column 9 - line 198, column 116): " + [ v2.constructor.name ]);
                                      };
                                      if (v1 instanceof Data_Maybe.Nothing) {
                                          return Control_Monad_Error_Class.throwError(Control_Monad_Except_Trans.monadThrowExceptT(dictMonad))({
                                              priority: depth,
                                      ...
                                      throw new Error("Failed pattern match at Nodetrout.Internal.Router (line 192, column 46 - line 200, column 118): " + [ v1.constructor.name ]);
                                  });
                              };
                          };
                      };
      ...
      return function __do() {
              ...
              return function __do() {
                  ...
                  (function () {
                      if (previousData instanceof Data_Maybe.Just) {
                          return done(new Data_Either.Right(previousData.value0))();
                      };
                      if (previousData instanceof Data_Maybe.Nothing) {
                          ...
                          return Node_Stream.onEnd(Node_HTTP.requestAsStream(req))(function __do() {
                              ...
                              return done(new Data_Either.Right(buffer))();
                          })();
                      };
                      throw new Error("Failed pattern match at Nodetrout.Internal.Server.Node (line 41, column 9 - line 50, column 34): " + [ previousData.constructor.name ]);
                  })();
                  return Effect_Aff.nonCanceler;
              };
          });
          return {
              ...
              stringBody: Data_Functor.map(Effect_Aff.functorAff)((function () {
                  var $19 = Data_Foldable.find(Data_Foldable.foldableMaybe)(function (v) {
                      return v !== "";
                  });
                  return function ($20) {
                      return $19(Data_Maybe.Just.create($20));
                  };
              })())(Control_Bind.bindFlipped(Effect_Aff.bindAff)((function () {
                  var $21 = Effect_Class.liftEffect(Effect_Aff.monadEffectAff);
                  var $22 = Node_Buffer_Class.toString(Node_Buffer.mutableBufferEffect)(Node_Encoding.UTF8.value);
                  return function ($23) {
                      return $21($22($23));
                  };
              })())(body))
                                                  ...
                                                  return Effect_Class.liftEffect(dictMonadEffect)((function () {
                                                      ...
                                                      if (result instanceof Data_Either.Right) {
                                                          return function __do() {
                                                              ...
                                                              writeResponse(dictResponseWritable)(rs)(result.value0.value1)();
                                                              return Node_Stream.end(rs)(Control_Applicative.pure(Effect.applicativeEffect)(Data_Unit.unit))();
                                                          };
                                                      };
                                                      throw new Error("Failed pattern match at Nodetrout.Internal.Server.Node (line 91, column 20 - line 102, column 36): " + [ result.constructor.name ]);
                                                  })());
                                              });
                                          })));
                                      };
...
(function($PS) {
  ...
  var validateTransfer = function (v) {
      return Control_Bind.bind(Control_Monad_Except_Trans.bindExceptT(Control_Monad_Reader_Trans.monadReaderT(Effect_Aff.monadAff)))(Control_Monad_Reader_Class.ask(Control_Monad_Except_Trans.monadAskExceptT(Control_Monad_Reader_Trans.monadAskReaderT(Effect_Aff.monadAff))))(function (v1) {
          ...
          return Control_Bind.bind(Control_Monad_Except_Trans.bindExceptT(Control_Monad_Reader_Trans.monadReaderT(Effect_Aff.monadAff)))(Effect_Aff_Class.liftAff(Effect_Aff_Class.monadAffExceptT(Effect_Aff_Class.monadAffReader(Effect_Aff_Class.monadAffAff)))(Network_Ethereum_Web3_Types_Types.runWeb3(v1.provider)(Control_Bind.bind(Network_Ethereum_Web3_Types_Types.bindWeb3)(Contracts_RelayableNFT.ownerOf(txOpts)(Network_Ethereum_Web3_Types_Types.Latest.value)({
              ...
              throw new Error("Failed pattern match at Routes.Relay (line 66, column 3 - line 68, column 51): " + [ res.constructor.name ]);
          });
      });
  };
  var resolveRelayRequestBody = function (v) {
      ...
      throw new Error("Failed pattern match at Routes.Relay (line 70, column 1 - line 70, column 126): " + [ v.constructor.name ]);
  };
  var postValidateRoute = function (v) {
      return {
          POST: Data_Maybe.maybe(Control_Monad_Error_Class.throwError(Control_Monad_Except_Trans.monadThrowExceptT(Control_Monad_Reader_Trans.monadReaderT(Effect_Aff.monadAff)))(Nodetrout_Internal_Error.error400))(Control_Applicative.pure(Control_Monad_Except_Trans.applicativeExceptT(Control_Monad_Reader_Trans.monadReaderT(Effect_Aff.monadAff))))(Data_Functor.map(Data_Maybe.functorMaybe)(DApp_Relay_Types.interpretDecodedMessage(function ($45) {
              return Data_Either.hush(DApp_Message.parseDAppMessage(Data_ByteString.fromUTF8($45)));
  ...
  var getTxStatusRoute = function (v) {
      var getTxStatus = Control_Bind.bind(Network_Ethereum_Web3_Types_Types.bindWeb3)(Network_Ethereum_Web3_Api.eth_getTransactionReceipt(v))(function (v1) {
          return Control_Applicative.pure(Network_Ethereum_Web3_Types_Types.applicativeWeb3)(Data_Eq.eq(Network_Ethereum_Web3_Types_Types.eqTransactionStatus)(v1.status)(Network_Ethereum_Web3_Types_Types.Succeeded.value));
      });
      return {
          GET: Control_Bind.bind(Control_Monad_Except_Trans.bindExceptT(Control_Monad_Reader_Trans.monadReaderT(Effect_Aff.monadAff)))(Control_Monad_Reader_Class.ask(Control_Monad_Except_Trans.monadAskExceptT(Control_Monad_Reader_Trans.monadAskReaderT(Effect_Aff.monadAff))))(function (v1) {
              return Control_Monad_Except_Trans.withExceptT(Control_Monad_Reader_Trans.functorReaderT(Effect_Aff.functorAff))(web3ErrorToHTTPError)(Control_Bind.bindFlipped(Control_Monad_Except_Trans.bindExceptT(Control_Monad_Reader_Trans.monadReaderT(Effect_Aff.monadAff)))(Control_Monad_Except_Trans.except(Control_Monad_Reader_Trans.applicativeReaderT(Effect_Aff.applicativeAff)))(Effect_Aff_Class.liftAff(Effect_Aff_Class.monadAffExceptT(Effect_Aff_Class.monadAffReader(Effect_Aff_Class.monadAffAff)))(Network_Ethereum_Web3_Types_Types.runWeb3(v1.provider)(getTxStatus))));
          })
      };
  };
  ...
  var fromStringRelayRequestBody = new MIME.FromString((function () {
      var $46 = Data_Functor.map(Data_Either.functorEither)((function () {
          var $49 = MIME.toByteString(MIME.toByteStringHexString);
          return function ($50) {
              return RelayRequestBody($49($50));
          };
      })());
      var $47 = MIME.fromString(MIME.fromStringHexString);
      return function ($48) {
          return $46($47($48));
      };
  })());
      ...
      return Control_Bind.bind(Effect_Aff.bindAff)(Effect_Class.liftEffect(Effect_Aff.monadEffectAff)(Data_Functor.map(Effect.functorEffect)(Data_Maybe.fromMaybe("build/RelayableNFT.json"))(Node_Process.lookupEnv("RELAYABLENFT_ARTIFACT"))))(function (rnftPath) {
          return Control_Bind.bind(Effect_Aff.bindAff)(Effect_Class.liftEffect(Effect_Aff.monadEffectAff)(Data_Functor.map(Effect.functorEffect)(Data_Maybe.fromMaybe("build/FungibleToken.json"))(Node_Process.lookupEnv("FUNGIBLETOKEN_ARTIFACT"))))(function (ftPath) {
              return Chanterelle_Internal_Utils_Error["withExceptT'"](Effect_Aff.monadThrowAff)(Effect_Exception.error)((function () {
                          ...
                          return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_Except_Trans.bindExceptT(Effect_Aff.monadAff))(Chanterelle_Internal_Logging.log(Control_Monad_Except_Trans.monadEffectExceptT(Effect_Aff.monadEffectAff))(Chanterelle_Internal_Logging.Info.value)("Reading " + (name + (" artifact at " + path))))(function () {
                              return Control_Bind.bind(Control_Monad_Except_Trans.bindExceptT(Effect_Aff.monadAff))(Chanterelle_Internal_Artifact.readArtifact(Effect_Aff_Class.monadAffExceptT(Effect_Aff_Class.monadAffAff))(Control_Monad_Except_Trans.monadThrowExceptT(Effect_Aff.monadAff))(path))(function (art) {
                                  ...
                                  return Control_Bind.bind(Control_Monad_Except_Trans.bindExceptT(Effect_Aff.monadAff))(Data_Maybe.maybe(Control_Monad_Error_Class.throwError(Control_Monad_Except_Trans.monadThrowExceptT(Effect_Aff.monadAff))("Couldn't find valid deploy address for chain ID " + (Data_Show.show(Data_Show.showInt)(networkID) + (" in artifact: " + path))))(Control_Applicative.pure(Control_Monad_Except_Trans.applicativeExceptT(Effect_Aff.monadAff)))(maddress))(function (addr) {
                                      return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_Except_Trans.bindExceptT(Effect_Aff.monadAff))(Chanterelle_Internal_Logging.log(Control_Monad_Except_Trans.monadEffectExceptT(Effect_Aff.monadEffectAff))(Chanterelle_Internal_Logging.Info.value)("Using " + (name + (" address: " + Data_Show.show(Network_Ethereum_Core_Signatures.addressShow)(addr)))))(function () {
                  ...
                  return Control_Bind.bind(Control_Monad_Except_Trans.bindExceptT(Effect_Aff.monadAff))(readArtifact$prime("RelayableNFT")(rnftPath))(function (rnft) {
                      return Control_Bind.bind(Control_Monad_Except_Trans.bindExceptT(Effect_Aff.monadAff))(readArtifact$prime("FungibleToken")(ftPath))(function (ft) {
          ...
          return Control_Bind.bind(Effect_Aff.bindAff)(Effect_Class.liftEffect(Effect_Aff.monadEffectAff)(Node_Process.lookupEnv("RELAYER_PRIVATE_KEY")))(function (relayerPrivateKeyEnv) {
              ...
              return Control_Bind.bind(Effect_Aff.bindAff)(Network_Ethereum_Web3_Types_Types.runWeb3(provider)(Control_Bind.bind(Network_Ethereum_Web3_Types_Types.bindWeb3)(Data_Functor.mapFlipped(Network_Ethereum_Web3_Types_Types.functorWeb3)(Network_Ethereum_Web3_Api.net_version)(function (chainIDString) {
                          ...
                          return Control_Bind.bind(Network_Ethereum_Web3_Types_Types.bindWeb3)((function () {
                              ...
                              if (relayerPrivateKey instanceof Data_Maybe.Nothing) {
                                  return Control_Bind.bind(Network_Ethereum_Web3_Types_Types.bindWeb3)(Data_Functor.mapFlipped(Network_Ethereum_Web3_Types_Types.functorWeb3)(Network_Ethereum_Web3_Api.eth_getAccounts)(Data_Array.head))(function (v) {
                                      ...
                                      throw new Error("Failed pattern match at Main (line 97, column 47 - line 102, column 49): " + [ v.constructor.name ]);
                                  });
                              };
                              throw new Error("Failed pattern match at Main (line 92, column 23 - line 102, column 49): " + [ relayerPrivateKey.constructor.name ]);
                  ...
                  return Control_Bind.bind(Effect_Aff.bindAff)((function () {
                      ...
                      throw new Error("Failed pattern match at Main (line 104, column 14 - line 106, column 36): " + [ eWeb3Env.constructor.name ]);
                  })())(function (web3Env) {
                      return Control_Bind.bind(Effect_Aff.bindAff)(readArtifacts(web3Env.chainIDInt))(function (artifacts) {
                          ...
                          return Control_Bind.bind(Effect_Aff.bindAff)((function () {
                              ...
                              throw new Error("Failed pattern match at Main (line 118, column 10 - line 124, column 10): " + [ relayerPrivateKey.constructor.name ]);
      ...
      return Control_Bind.bind(Effect_Aff.bindAff)(Effect_Class.liftEffect(Effect_Aff.monadEffectAff)(Node_Process.lookupEnv("SERVER_PORT")))(function (portS) {
          return Control_Bind.bind(Effect_Aff.bindAff)((function () {
              ...
              return Control_Bind.bind(Effect_Aff.bindAff)(mkEnv)(function (env) {
                  return Control_Bind.bind(Effect_Aff.bindAff)(Effect_Class.liftEffect(Effect_Aff.monadEffectAff)(Node_HTTP.createServer(withLoggingMiddleware(Nodetrout.serve(Control_Monad_Reader_Trans.monadReaderT(Effect_Aff.monadAff))(Control_Monad_Reader_Trans.monadEffectReader(Effect_Aff.monadEffectAff))(Nodetrout_Internal_Server_Node.responseWritableString)(Nodetrout_Internal_Router.routerAltNamed(Control_Monad_Reader_Trans.monadReaderT(Effect_Aff.monadAff))(Nodetrout_Internal_Router.routerResource(Control_Monad_Reader_Trans.monadReaderT(Effect_Aff.monadAff))(Nodetrout_Internal_Router.routerMethod(Control_Monad_Reader_Trans.monadReaderT(Effect_Aff.monadAff))(new Data_Symbol.IsSymbol(function () {
                      return "GET";
                  }))(Type_Trout_ContentType.allMimeRenderAlt(Type_Trout_ContentType_JSON.mimeRenderJson(Routes_NullRoute.encodeJsonNullRouteRes))(Type_Trout_ContentType_JSON.hasMediaTypeJson)(Type_Trout_ContentType_HTML.mimeRenderHTMLEncodeHTML(Routes_NullRoute.encodeHTMLNullRouteRes))(Type_Trout_ContentType_HTML.hasMediaTypeHTML))()))(Nodetrout_Internal_Router.routerAltNamed(Control_Monad_Reader_Trans.monadReaderT(Effect_Aff.monadAff))(Nodetrout_Internal_Router.routerLit(Control_Monad_Reader_Trans.monadReaderT(Effect_Aff.monadAff))(Nodetrout_Internal_Router.routerResource(Control_Monad_Reader_Trans.monadReaderT(Effect_Aff.monadAff))(Nodetrout_Internal_Router.routerMethod(Control_Monad_Reader_Trans.monadReaderT(Effect_Aff.monadAff))(new Data_Symbol.IsSymbol(function () {
                      return "GET";
                  }))(Type_Trout_ContentType_JSON.allMimeRenderJson(Routes_ChainInfo.encodeJsonChainInfo))()))(new Data_Symbol.IsSymbol(function () {
                      return "chain";
                      ...
                      return "POST";
                  }))(Type_Trout_ContentType.allMimeRenderAlt(Type_Trout_ContentType_JSON.mimeRenderJson(Network_Ethereum_Core_HexString.encodeJsonHexString))(Type_Trout_ContentType_JSON.hasMediaTypeJson)(MIME.showMimeRenderPlaintext(Network_Ethereum_Core_HexString.showHexString))(MIME.hasMediaTypePlaintext))()))(MIME.fromStringMimeParsePlaintext(Routes_Relay.fromStringRelayRequestBody)))(new Data_Symbol.IsSymbol(function () {
                      return "submit";
                  })))(Nodetrout_Internal_Router.routerAltNamed(Control_Monad_Reader_Trans.monadReaderT(Effect_Aff.monadAff))(Nodetrout_Internal_Router.routerLit(Control_Monad_Reader_Trans.monadReaderT(Effect_Aff.monadAff))(Nodetrout_Internal_Router.routerReqBody(Control_Monad_Reader_Trans.monadReaderT(Effect_Aff.monadAff))(Effect_Aff_Class.monadAffReader(Effect_Aff_Class.monadAffAff))(Nodetrout_Internal_Router.routerResource(Control_Monad_Reader_Trans.monadReaderT(Effect_Aff.monadAff))(Nodetrout_Internal_Router.routerMethod(Control_Monad_Reader_Trans.monadReaderT(Effect_Aff.monadAff))(new Data_Symbol.IsSymbol(function () {
                      return "POST";
                  }))(Type_Trout_ContentType.allMimeRenderAlt(Type_Trout_ContentType_JSON.mimeRenderJson(DApp_Relay_Types.encodeJsonInterpretedDecodedMessage(DApp_Message.encodeJsonDAppMessage)))(Type_Trout_ContentType_JSON.hasMediaTypeJson)(MIME.showMimeRenderPlaintext(DApp_Relay_Types.showInterpretedDecodedMessage(DApp_Message.genericDAppMessage)(DApp_Message.showDAppMessage)))(MIME.hasMediaTypePlaintext))()))(MIME.fromStringMimeParsePlaintext(Routes_Relay.fromStringRelayRequestBody)))(new Data_Symbol.IsSymbol(function () {
                      return "validate";
                  })))(Nodetrout_Internal_Router.routerAltNamed(Control_Monad_Reader_Trans.monadReaderT(Effect_Aff.monadAff))(Nodetrout_Internal_Router.routerLit(Control_Monad_Reader_Trans.monadReaderT(Effect_Aff.monadAff))(Nodetrout_Internal_Router.routerCapture(Control_Monad_Reader_Trans.monadReaderT(Effect_Aff.monadAff))(Nodetrout_Internal_Router.routerResource(Control_Monad_Reader_Trans.monadReaderT(Effect_Aff.monadAff))(Nodetrout_Internal_Router.routerMethod(Control_Monad_Reader_Trans.monadReaderT(Effect_Aff.monadAff))(new Data_Symbol.IsSymbol(function () {
                      return "GET";
                  }))(Type_Trout_ContentType.allMimeRenderAlt(Type_Trout_ContentType_JSON.mimeRenderJson(Network_Ethereum_Core_BigNumber.encodeJsonBigNumber))(Type_Trout_ContentType_JSON.hasMediaTypeJson)(MIME.showMimeRenderPlaintext(Network_Ethereum_Core_BigNumber.showBigNumber))(MIME.hasMediaTypePlaintext))()))(MIME.fromPathPieceTWAddress))(new Data_Symbol.IsSymbol(function () {
                      return "nonce";
                  })))(Nodetrout_Internal_Router.routerNamed(Control_Monad_Reader_Trans.monadReaderT(Effect_Aff.monadAff))(Nodetrout_Internal_Router.routerLit(Control_Monad_Reader_Trans.monadReaderT(Effect_Aff.monadAff))(Nodetrout_Internal_Router.routerCapture(Control_Monad_Reader_Trans.monadReaderT(Effect_Aff.monadAff))(Nodetrout_Internal_Router.routerResource(Control_Monad_Reader_Trans.monadReaderT(Effect_Aff.monadAff))(Nodetrout_Internal_Router.routerMethod(Control_Monad_Reader_Trans.monadReaderT(Effect_Aff.monadAff))(new Data_Symbol.IsSymbol(function () {
                      return "GET";
                  }))(Type_Trout_ContentType.allMimeRenderAlt(Type_Trout_ContentType_JSON.mimeRenderJson(Data_Argonaut_Encode_Class.encodeJsonJBoolean))(Type_Trout_ContentType_JSON.hasMediaTypeJson)(MIME.showMimeRenderPlaintext(Data_Show.showBoolean))(MIME.hasMediaTypePlaintext))()))(MIME.fromPathPieceTWHexString))(new Data_Symbol.IsSymbol(function () {
                      return "status";
                  })))(new Data_Symbol.IsSymbol(function () {
                      return "tx_status";
                  }))())(new Data_Symbol.IsSymbol(function () {
