...
(function($PS) {
  // Generated by purs version 0.13.8
  "use strict";
  $PS["UI.Block.Backdrop"] = $PS["UI.Block.Backdrop"] || {};
  var exports = $PS["UI.Block.Backdrop"];
  var Data_Functor = $PS["Data.Functor"];
  var Data_Semigroup = $PS["Data.Semigroup"];
  var Halogen_HTML_Core = $PS["Halogen.HTML.Core"];
  var Halogen_HTML_Elements = $PS["Halogen.HTML.Elements"];
...
(function($PS) {
  // Generated by purs version 0.13.8
  "use strict";
  $PS["UI.Block.Documentation"] = $PS["UI.Block.Documentation"] || {};
  var exports = $PS["UI.Block.Documentation"];
  var Data_Functor = $PS["Data.Functor"];
  var Halogen_HTML_Core = $PS["Halogen.HTML.Core"];
  var Halogen_HTML_Elements = $PS["Halogen.HTML.Elements"];
  var Halogen_HTML_Properties = $PS["Halogen.HTML.Properties"];
...
(function($PS) {
  "use strict";
  $PS["UI.Component.Table"] = $PS["UI.Component.Table"] || {};
  var exports = $PS["UI.Component.Table"];
  var Data_EuclideanRing = $PS["Data.EuclideanRing"];
  var Data_Function = $PS["Data.Function"];
  var Data_Functor = $PS["Data.Functor"];
  var Data_Ord = $PS["Data.Ord"];
  ...
  var Ocelot_HTML_Properties = $PS["Ocelot.HTML.Properties"];
  var UI_Block_Backdrop = $PS["UI.Block.Backdrop"];
  var UI_Block_Documentation = $PS["UI.Block.Documentation"];                
  var tableData = [ {
  ...
  var component = (function () {
      var render = function (v) {
          ...
          return Halogen_HTML_Elements.div_([ UI_Block_Documentation.block_({
              header: "Table",
              subheader: "Tabular Data"
          })([ UI_Block_Backdrop.backdrop_([ renderTable ]) ]) ]);
      };
...
(function($PS) {
  ...
  var UI_Component_Table = $PS["UI.Component.Table"];                
  var main = Halogen_Aff_Util.runHalogenAff(Control_Bind.bind(Effect_Aff.bindAff)(Halogen_Aff_Util.awaitBody)(function (body) {
      return Halogen_VDom_Driver.runUI(UI_Component_Table.component)(Data_Unit.unit)(body);
  }));
  exports["main"] = main;
})(PS);
PS["Main"].main();
