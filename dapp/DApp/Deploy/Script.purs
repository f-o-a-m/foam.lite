...
wrapDeployed :: forall a. String -> String -> ContractConfig a -> DeployM { deployAddress :: Address, deployHash :: HexString, deployArgs :: Record a }
wrapDeployed h a args = pure { deployHash: mkHexString' h, deployAddress: mkAddress' a, deployArgs: unsafePartial fromRight (vToEither args.unvalidatedArgs) }
...
deployScript = do
  ...
  fungibleToken <- 
    if networkID == 1
    then pure { deployHash: mkHexString' "0x6cadd5e8960f526803f23a72a9232492a028502a81aa71fb21beb6907d345313"
              , deployAddress: mkAddress' "0x4946fcea7c692606e8908002e55a582af44ac121"
              , deployArgs: { initialSupply }
              }
    else if networkID == 4
    then pure { deployHash: mkHexString' "0x37a7f0318f8b6689a4667768a49050d4878b38323838ef8f88f1dc8173295597"
              , deployAddress: mkAddress' "0xf450fab8717f7910fc508d2224cad0bf3321517a"
              , deployArgs: { initialSupply }
              }
